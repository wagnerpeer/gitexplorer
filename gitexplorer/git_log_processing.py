            ...
            if(line):
                ...
                if(line.startswith(('create', 'delete'))):
                    ...
                    if(permission_change is None):
                        cls.logger.warning('Unparsable permission change in commit {} detected: "{}"'.format(commit_hash, line))
                        continue
                    ...
                    if('=>' in file_path):
                        ...
                        if(paths_match is None):
                            cls.logger.warning('Unparsable path_rename in commit {} detected: "{}"'.format(commit_hash, line))
                            continue
